@extends('layouts.app')
@section('title', __('Add New Dog'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('Add New Dog')</h1>
    <!-- <ol class="breadcrumb">
...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-3 @if(!session('business.enable_brand')) hide @endif">
          <div class="form-group">
            {!! Form::label('brand_id', __('Dog Breed') . ':') !!}
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('unit_id', __('Gender') . ':*') !!}
            <div class="input-group">
              <span class="input-group-btn hide">
              {!! Form::select('unit_id', $units, !empty($duplicate_product->unit_id) ? $duplicate_product->unit_id : session('business.default_unit'), ['class' => 'form-control select2 hide', 'required']); !!}
               <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn btn-default hide bg-white btn-flat btn-modal" data-href="{{action('UnitController@create', ['quick_add' => true])}}" title="@lang('unit.add_unit')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
              </span>
              {!! Form::select('gender', [null => 'Select Gender'] + ['Male' => 'Male','Female'=>'Female'], null, ['class' => 'form-control']) !!}

              <!-- {!! Form::select('gender',['Male' => 'Male','Female'=>'Female',],['class'=>'form-control select2','placeholder'=>'Select Gender']) !!} -->
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::date('product_custom_field1', !empty($duplicate_product->product_custom_field1) ? $duplicate_product->product_custom_field1 : null, ['class' => 'form-control', 'placeholder' => $product_custom_field1]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::date('product_custom_field2', !empty($duplicate_product->product_custom_field2) ? $duplicate_product->product_custom_field2 : null, ['class' => 'form-control', 'placeholder' => $product_custom_field2]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::date('product_custom_field4', !empty($duplicate_product->product_custom_field4) ? $duplicate_product->product_custom_field4 : null, ['class' => 'form-control', 'placeholder' => $product_custom_field4]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('product_custom_field5',  'Number of Litter Had:') !!}
            {!! Form::text('product_custom_field5', !empty($duplicate_product->product_custom_field5) ? $duplicate_product->product_custom_field5 : null, ['class' => 'form-control', 'placeholder' => 'Number of Litter Had']); !!}
          </div>
        </div>

        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('product_custom_field6',   'Last Litter Birth date:') !!}
            {!! Form::date('product_custom_field6', !empty($duplicate_product->product_custom_field6) ? $duplicate_product->product_custom_field6 : null, ['class' => 'form-control', 'placeholder' => 'Last Litter Birth date']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('product_custom_field7',   'Last Mated date:') !!}
            {!! Form::date('product_custom_field7', !empty($duplicate_product->product_custom_field7) ? $duplicate_product->product_custom_field7 : null, ['class' => 'form-control', 'placeholder' => 'Last Mated date']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-3 @if(!session('business.enable_category')) hide @endif">
          <div class="form-group">
            {!! Form::label('category_id', __('Color') . ':') !!}
        ...
        @if(session('business.enable_product_expiry'))
            ...
            @else
              ...
              @endphp
            @endif
          <div class="col-sm-4 hide @if($hide) hide @endif">
            <div class="form-group">
              <div class="multi-input">
                {!! Form::label('expiry_period', __('Vacination') . ':') !!}<br>
                {!! Form::text('expiry_period', !empty($duplicate_product->expiry_period) ? @num_format($duplicate_product->expiry_period) : $expiry_period, ['class' => 'form-control pull-left input_number',
                  'placeholder' => __('vacination period'), 'style' => 'width:60%;']); !!}
        ...
        <div class="col-sm-3 hide" >
          <div class="form-group">
            {!! Form::label('weight',  __('Number of Puppies') . ':') !!}
            {!! Form::text('weight', !empty($duplicate_product->weight) ? $duplicate_product->weight : null, ['class' => 'form-control', 'placeholder' => __('Number of Puppies')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div" style="display: none;">
          <div class="form-group">
