...
<tr>
    <td>
        ...
        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][puppy_name]', null, ['class' => 'form-control input-sm input_sub_sku']); !!}

       
        {!! Form::hidden($name . '[' . $variation_index . '][variations][' . $value_index . '][variation_value_id]', $variation_value_id) !!}
    </td>
    <td>
        {!! Form::label('name', __('Microchip No') . ':*') !!}
    ...
    <td class="{{$class}}">
            ...
            {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][puppy_color]', null, ['class' => 'form-control input-sm input_sub_sku']); !!}

    </td>
    <td class="{{$class}}">
        
        <div class="">
            {!! Form::label('dpp', __(' Default purchase price')) !!}
        ...
        <div class="width-50 f-left hide">
    ...
    <td class="{{$class}}">
        <div class="input-group">
            {!! Form::label('dpp', __(' Profit Margin')) !!}
    ...
    <td>
            {!! Form::label('dpp', __('Selling Price')) !!}
...
<tr>
    <td class="{{$class}}">
            ...
            {!! Form::date($name . '[' . $variation_index . '][variations][' . $value_index . '][puppy_dob]', null, ['class' => 'form-control input-sm input_sub_sku']); !!}
        
    </td>
    <td class="{{$class}}">
        
        <div class="f-left">
            {!! Form::label('dob', __(' Vaccination 1st') . ':') !!}
            {!! Form::date($name . '[' . $variation_index . '][variations][' . $value_index . '][Vaccination_1st]', null, ['class' => 'form-control input-sm input_sub_sku']); !!}
        </div>
    </td>
    <td class="{{$class}}">
        <div class=" f-left">
            {!! Form::label('dob', __(' Vaccination 2nd') . ':') !!}
            {!! Form::date($name . '[' . $variation_index . '][variations][' . $value_index . '][Vaccination_2nd]', null, ['class' => 'form-control input-sm input_sub_sku']); !!}
