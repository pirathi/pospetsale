...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-3 @if(!(session('business.enable_category') && session('business.enable_sub_category')))  @endif">
              <div class="form-group">
                {!! Form::label('sku', __('Microchip No')  . ':*') !!} 
            ...
            <div class="col-sm-4 hide @if(!session('business.enable_sub_units')) hide @endif">
              <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::date('product_custom_field2', $product->product_custom_field2, ['class' => 'form-control', 'placeholder' => $product_custom_field2]); !!}
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::date('product_custom_field4', $product->product_custom_field4, ['class' => 'form-control', 'placeholder' => $product_custom_field4]); !!}
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::text('product_custom_field5', $product->product_custom_field5, ['class' => 'form-control', 'placeholder' => 'Number of Litter Had']); !!}
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                {!! Form::date('product_custom_field6', $product->product_custom_field6, ['class' => 'form-control', 'placeholder' => 'Last Litter Birth date']); !!}
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                {!! Form::label('product_custom_field7',   'Last Mated date:') !!}
                {!! Form::date('product_custom_field7', $product->product_custom_field7, ['class' => 'form-control', 'placeholder' => 'Last Mated date']); !!}
              </div>
            </div>
