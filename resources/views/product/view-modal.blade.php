      		...
      		<div class="row">
      			<div class="col-sm-9">
					  ...
					  @if(!empty($product->product_custom_field1))
						...
						@endif
						@if(!empty($product->product_custom_field5))
							<br/>
							<b>{{ $custom_labels['product']['custom_field_5'] ?? __('Number of Litter Had') }}: </b>
							{{$product->product_custom_field5 }}
						@endif
						@if(!empty($product->product_custom_field6))
							<br/>
							<b>{{ $custom_labels['product']['custom_field_6'] ?? __('Last Litter Birth date') }}: </b>
							{{$product->product_custom_field6 }}
						@endif
						@if(!empty($product->product_custom_field7))
							<br/>
							<b>{{ $custom_labels['product']['custom_field_7'] ?? __('Last Mated date') }}: </b>
							{{$product->product_custom_field7 }}
						@endif
