        ...
        <div class="row">
          ...
          <!-- <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('custom_field2', [null => 'Select Color'] + ['#008000'=>'Green','#FFFF00'=>'Yellow','#FF0000' => 'Red',], null, ['class' => 'form-control']) !!} -->
          ...
          <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('custom_field1', $contact_custom_field1 . ':') !!}
                {!! Form::select('custom_field1', [null => 'Select Type'] + ['#008000'=>'Normal','#EC5800' => 'Difficult','#FF0000'=>'Hard',], null, ['class' => 'form-control']) !!}
