...
<section class="content no-print">
	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-6 @else col-md-10 col-md-offset-1 @endif pr-12">
				...
				<div class="col-md-6 bg-white p-5" style="padding: 15px;">
