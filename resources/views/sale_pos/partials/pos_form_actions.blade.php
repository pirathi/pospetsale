...
<!--			@if(empty($edit))-->
<!--				<button type="button" class="btn btn-danger btn-flat pull-right  @if($is_mobile) col-xs-6  @endif" id="pos-cancel"> <i class="fas fa-window-close"></i> @lang('sale.cancel')</button>-->
<!--			@else-->
<!--				<button type="button" class="btn btn-danger btn-flat pull-right hide @if($is_mobile) col-xs-6 @else btn-xs @endif" id="pos-delete"> <i class="fas fa-trash-alt"></i> @lang('messages.delete')</button>-->
<!--			@endif-->
