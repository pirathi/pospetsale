<div class="row">
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("amount_$row_index" ,__('Deposit') . ':*') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fas fa-money-bill-alt"></i>
				</span>
				{!! Form::text("payment[$row_index][amount]", @num_format($payment_line['amount']), ['class' => 'form-control payment-amount input_number', 'required','autofocus', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount'), 'readonly' => $readonly]); !!}
					
						

			</div>
				<div class=""><strong>@lang('lang_v1.balance'):</strong> <span class="balance_due" id="balncedue">0.00</span></div>
		</div>
	</div>
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("amount_$row_index" ,__('Extra Payment') . ':*') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fas fa-money-bill-alt"></i>
				</span>
				{!! Form::text("payment[$row_index][expayment]", $payment_line['expayment'], ['class' => 'form-control input_number', 'required','autofocus', 'placeholder' => __('No.of Extra Payment'), 'readonly' => $readonly]); !!}
			</div>
		</div>
	</div>
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("amount_$row_index" ,__('Payment Each Fortnight') . ':*') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fas fa-money-bill-alt"></i>
				</span>
				{!! Form::text("payment[$row_index][paymentfortnight]", $payment_line['paymentfortnight'], ['class' => 'form-control input_number', 'required','autofocus', 'placeholder' => __('sale.amount') ]); !!}
			</div>
		</div>
	</div>
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("amount_$row_index" ,__('Number of Payment') . ':*') !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fas fa-money-bill-alt"></i>
				</span>
				{!! Form::text("payment[$row_index][noofpayment]", $payment_line['noofpayment'], ['class' => 'form-control input_number', 'required','autofocus', 'id' => "noof_payment", 'placeholder' => __('No. of Payment') ]); !!}
			</div>
		</div>
	</div>
	@if(!empty($show_date))
