    ...
    <body class="mt-0 px-0">
        <div class="ticket">
			...
			<div class="border-top textbox-info">
				...
				<p class="f-left"><strong>Invoice No : </strong>{{$receipt_details->invoice_no}}</p>
				<p class="f-right">
			...
			@endif
            <table style="margin-top: 5px !important" class="border-bottom width-100 table-f-12 mb-5">
                <thead class="border-bottom-dotted">
                    <tr>
                        <th class="serial_number">#</th>
                        <th class="description" width="20%" style="font-size: 10px;">
                ...
                <tbody>
                	@forelse($receipt_details->lines as $line)
	                    <tr>
	                        <td class="serial_number" style="vertical-align: top; font-size: 10px;">
	                        	{{$loop->iteration}}
	                        </td>
	                        <td class="description"  style="font-size: 10px;font-family: 'Tiro Tamil', serif;">
	                        ...
	                        <td class="quantity text-center"  style="font-size: 10px;">{{$line['quantity']}} <span style="font-size: 10px;">{{$line['units']}}</span></td>
	                        @if(empty($receipt_details->hide_price))
			...
			@if(empty($receipt_details->hide_price))
				...
				@if(!empty($receipt_details->payments))
					@foreach($receipt_details->payments as $payment)
						<div class="flex-box"> 
						<!--({{$payment['date']}})-->
							<p class="width-50 text-right">{{ $payment['method'] == 'Cash' ? 'Cash' : 'Blance' }} </p>
				...
				@endif
			@endif
            <div class="border-bottom width-100 mb-0">&nbsp;</div>
