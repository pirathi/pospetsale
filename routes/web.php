...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/product-puppies-alert', 'HomeController@getPuppiesDetails');
    Route::get('/home/puppies-vaccination', 'HomeController@getPuppiesVaccination');
    ...
    Route::get('/reports/today-sell', 'ReportController@SellToday'); //today report
