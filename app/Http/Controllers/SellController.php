    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->addColumn('conatct_name', '@if(!empty($supplier_business_name)) {{$supplier_business_name}}, <br> @endif'.'<i style="color:{{$custom_field1}};font-size: 20px;" class="fa fas fa-user"></i> {{$name}}')
