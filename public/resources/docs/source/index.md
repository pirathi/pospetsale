...
[Get Postman Collection](https://pos.e-buy.lk/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"asperiores","ip_address":"nemo","latitude":"quas","longitude":"distinctio"}'
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"tempore","latitude":"nemo","longitude":"perspiciatis"}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=voluptas&follow_up_type=est&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"velit","schedule_type":"et","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=nisi&biz_name=consequatur&mobile_num=9&contact_id=modi&order_by=autem&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/crm/leads"
);

let params = {
    "assigned_to": "1,2,3",
    "name": "nisi",
    "biz_name": "consequatur",
    "mobile_num": "9",
    "contact_id": "modi",
    "order_by": "autem",
    "direction": "desc",
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"ut","mobile_name":"qui","call_type":"call","start_time":"dolores","end_time":"soluta","duration":"cumque"}]}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":68528912.407,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":5,"total_card_slips":6,"total_cheques":15,"closing_note":"eligendi","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/contactapi?type=ducimus&name=et&biz_name=corrupti&mobile_num=1&contact_id=error&order_by=corrupti&direction=in&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"numquam","prefix":"voluptas","first_name":"dolores","middle_name":"a","last_name":"fuga","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"sequi","address_line_2":"odio","city":"aut","state":"et","country":"fuga","zip_code":"excepturi","customer_group_id":"enim","contact_id":"quo","dob":"2000-06-13","custom_field1":"fuga","custom_field2":"architecto","custom_field3":"nesciunt","custom_field4":"ut","email":"consequatur","shipping_address":"atque","position":"sed","opening_balance":0,"source_id":13,"life_stage_id":11,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "numquam",
    "prefix": "voluptas",
    "first_name": "dolores",
    "middle_name": "a",
    "last_name": "fuga",
    ...
    "dob": "2000-06-13",
    "custom_field1": "fuga",
    "custom_field2": "architecto",
    "custom_field3": "nesciunt",
    "custom_field4": "ut",
    "email": "consequatur",
    "shipping_address": "atque",
    "position": "sed",
    "opening_balance": 0,
    "source_id": 13,
    "life_stage_id": 11,
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eius","prefix":"voluptas","first_name":"mollitia","middle_name":"inventore","last_name":"voluptas","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"provident","address_line_2":"molestiae","city":"officiis","state":"sunt","country":"nulla","zip_code":"excepturi","customer_group_id":"harum","contact_id":"optio","dob":"2000-06-13","custom_field1":"molestiae","custom_field2":"architecto","custom_field3":"tenetur","custom_field4":"debitis","email":"iste","shipping_address":"fugiat","position":"laudantium","opening_balance":10.3,"source_id":2,"life_stage_id":3,"assigned_to":[]}'
...
let body = {
    ...
    "country": "nulla",
    "zip_code": "excepturi",
    "customer_group_id": "harum",
    "contact_id": "optio",
    "dob": "2000-06-13",
    "custom_field1": "molestiae",
    "custom_field2": "architecto",
    "custom_field3": "tenetur",
    "custom_field4": "debitis",
    "email": "iste",
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":15,"card_number":"voluptatem","card_holder_name":"et","card_transaction_number":"et","card_type":"odio","card_month":"amet","card_year":"voluptatum","card_security":"qui","transaction_no_1":"et","transaction_no_2":"voluptates","transaction_no_3":"asperiores","cheque_number":"sapiente","bank_account_number":"accusamus","note":"natus"}'
...
let body = {
    ...
    "account_id": 15,
    "card_number": "voluptatem",
    "card_holder_name": "et",
    "card_transaction_number": "et",
    "card_type": "odio",
    "card_month": "amet",
    "card_year": "voluptatum",
    "card_security": "qui",
    "transaction_no_1": "et",
    "transaction_no_2": "voluptates",
    "transaction_no_3": "asperiores",
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=aut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":25677876.2,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":17,"contact_id":1,"expense_category_id":10,"expense_sub_category_id":11,"additional_notes":"adipisci","is_refund":0,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"accusamus","recur_repetitions":5,"payment":[{"amount":453.13,"method":"cash","account_id":11,"card_number":"praesentium","card_holder_name":"reprehenderit","card_transaction_number":"possimus","card_type":"aut","card_month":"suscipit","card_year":"repellat","card_security":"libero","transaction_no_1":"est","transaction_no_2":"libero","transaction_no_3":"repellat","note":"et","cheque_number":"ad"}]}'
    ...
    "payment": [
        {
            ...
            "method": "cash",
            "account_id": 11,
            "card_number": "praesentium",
            "card_holder_name": "reprehenderit",
            "card_transaction_number": "possimus",
            "card_type": "aut",
            "card_month": "suscipit",
            "card_year": "repellat",
            "card_security": "libero",
            "transaction_no_1": "est",
            "transaction_no_2": "libero",
            "transaction_no_3": "repellat",
            "note": "et",
            "cheque_number": "ad"
        }
    ]
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://pos.e-buy.lk/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":675468.5,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":12,"expense_for":6,"contact_id":11,"expense_category_id":17,"expense_sub_category_id":16,"additional_notes":"consectetur","is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"asperiores","recur_repetitions":3,"payment":[]}'
...
let body = {
    ...
    "additional_notes": "consectetur",
    "is_recurring": 0,
    "recur_interval": 16,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "asperiores",
    "recur_repetitions": 3,
    "payment": []
}
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=at&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/field-force?contact_id=ratione&assigned_to=ratione&status=quia&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/field-force"
);
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":19,"visit_to":"aliquam","visit_address":"eius","assigned_to":8,"visit_on":"2021-12-28 17:23:00","visit_for":"mollitia"}'
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"enim","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"officiis","photo":"odit"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "enim",
...
<!-- START_49fdc039f14444b07c719f0810d31d9a -->
## New List products
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/new_product?order_by=quia&order_direction=consequatur&location_custom_field_1=possimus&category_id=maxime&sub_category_id=necessitatibus&location_id=1&not_for_sell=aut&send_lot_detail=qui&name=officiis&sku=et&product_ids=1%2C2&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/new_product"
);

let params = {
    "order_by": "quia",
    "order_direction": "consequatur",
    "location_custom_field_1": "possimus",
    "category_id": "maxime",
    "sub_category_id": "necessitatibus",
    "location_id": "1",
    "not_for_sell": "aut",
    "send_lot_detail": "qui",
    "name": "officiis",
...
--------- | ------- | ------- | -----------
    ...
    `location_custom_field_1` |  optional  | Custom field 1 of the location
    ...
    `product_ids` |  optional  | comma separated ids of products
    `per_page` |  optional  | Total records per page. default: 10, Set -1 for no pagination

<!-- END_49fdc039f14444b07c719f0810d31d9a -->

<!-- START_04d550a3d6f84df87a09c94a86c01248 -->
## New List sells
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/new_sell?location_id=1&contact_id=nulla&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=quia&service_staff_id=et&shipping_status=ordered&source=aut&customer_group_id=occaecati&product_name=et&product_sku=doloribus&product_custom_field_1=molestias&location_custom_field_1=qui&location_invoice_scheme_prefix=sed&product_category_id=maiores&product_sub_category_id=mollitia&sell_ids=55%2C64&only_subscriptions=vel&send_purchase_details=delectus&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/new_sell"
);
...
let params = {
    ...
    "product_name": "et",
    "product_sku": "doloribus",
    "product_custom_field_1": "molestias",
    "location_custom_field_1": "qui",
    "location_invoice_scheme_prefix": "sed",
    "product_category_id": "maiores",
    "product_sub_category_id": "mollitia",
    "sell_ids": "55,64",
    "only_subscriptions": "vel",
    "send_purchase_details": "delectus",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
--------- | ------- | ------- | -----------
    ...
    `customer_group_id` |  optional  | id of the customer group
    `product_name` |  optional  | name of the product
    `product_sku` |  optional  | sku of the product or variation
    `product_custom_field_1` |  optional  | custome field 1 of the product
    `location_custom_field_1` |  optional  | custome field 1 of the location
    `location_invoice_scheme_prefix` |  optional  | Invoice scheme prefix of the location
    `product_category_id` |  optional  | category id of the product
    `product_sub_category_id` |  optional  | Sub category id of the product
    `sell_ids` |  optional  | comma separated ids of the sells
...
<!-- END_04d550a3d6f84df87a09c94a86c01248 -->

<!-- START_12d2179b260d1969bcc682fc4d8aa51d -->
## New List contact
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/new_contactapi?type=eius&customer_group_id=expedita&custom_field_1=delectus&contact_ids=2%2C3&name=cumque&biz_name=placeat&mobile_num=19&contact_id=reiciendis&order_by=voluptas&direction=aut&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/new_contactapi"
);

let params = {
    "type": "eius",
    "customer_group_id": "expedita",
    "custom_field_1": "delectus",
    "contact_ids": "2,3",
    "name": "cumque",
    "biz_name": "placeat",
    "mobile_num": "19",
...
--------- | ------- | ------- | -----------
    `type` |  required  | Type of contact (supplier, customer)
    `customer_group_id` |  optional  | id of the customer group
    `custom_field_1` |  optional  | Custom field 1 of the contact
    `contact_ids` |  optional  | comma separated ids of contacts
    `name` |  optional  | Search term for contact name
    `biz_name` |  optional  | Search term for contact's business name
    `mobile_num` |  optional  | Search term for contact's mobile number
    `contact_id` |  optional  | Search term for contact's contact_id. Ex(CO0005)
...
<!-- END_12d2179b260d1969bcc682fc4d8aa51d -->
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/product?order_by=occaecati&order_direction=omnis&brand_id=quo&category_id=libero&sub_category_id=voluptatem&location_id=1&selling_price_group=veritatis&send_lot_detail=qui&name=consequatur&sku=placeat&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/product/1?selling_price_group=velit&send_lot_detail=ipsam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "velit",
    "send_lot_detail": "ipsam",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/variation/2?product_id=voluptatem&location_id=1&brand_id=molestiae&category_id=harum&sub_category_id=voluptatem&not_for_selling=consequatur&name=rerum&sku=iusto&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/sell?location_id=1&contact_id=amet&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=laudantium&service_staff_id=voluptatem&shipping_status=ordered&source=laborum&only_subscriptions=dolorem&send_purchase_details=laudantium&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "laudantium",
    "service_staff_id": "voluptatem",
    "shipping_status": "ordered",
    "source": "laborum",
    "only_subscriptions": "dolorem",
    "send_purchase_details": "laudantium",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":10,"transaction_date":"2020-07-22 15:48:29","invoice_no":"rerum","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":20,"discount_amount":10,"discount_type":"fixed","sale_note":"similique","staff_note":"magnam","commission_agent":11,"shipping_details":"Express Delivery","shipping_address":"enim","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":9,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":14,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"possimus","recur_repetitions":10,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"accusamus","service_custom_field_2":"et","service_custom_field_3":"architecto","service_custom_field_4":"est","service_custom_field_5":"hic","service_custom_field_6":"repellat","round_off_amount":43182.9,"table_id":10,"service_staff_id":11,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":9,"note":"fugiat"}],"payments":[{"amount":453.13,"method":"cash","account_id":12,"card_number":"tempore","card_holder_name":"sed","card_transaction_number":"voluptatem","card_type":"beatae","card_month":"magni","card_year":"magnam","card_security":"in","transaction_no_1":"est","transaction_no_2":"rerum","transaction_no_3":"aut","bank_account_number":"iste","note":"asperiores","cheque_number":"ut"}]}]}'
    ...
    "sells": [
        {
            ...
            "types_of_service_id": 17,
            "service_custom_field_1": "accusamus",
            "service_custom_field_2": "et",
            "service_custom_field_3": "architecto",
            "service_custom_field_4": "est",
            "service_custom_field_5": "hic",
            "service_custom_field_6": "repellat",
            "round_off_amount": 43182.9,
            "table_id": 10,
            "service_staff_id": 11,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "voluptatem",
                    "card_type": "beatae",
                    "card_month": "magni",
                    "card_year": "magnam",
                    "card_security": "in",
                    "transaction_no_1": "est",
                    "transaction_no_2": "rerum",
                    "transaction_no_3": "aut",
                    "bank_account_number": "iste",
                    "note": "asperiores",
                    "cheque_number": "ut"
                }
            ]
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/sell/55?send_purchase_details=velit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "velit",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "https://pos.e-buy.lk/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":3,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":20,"discount_amount":10,"discount_type":"fixed","sale_note":"vel","source":"optio","staff_note":"voluptatum","is_suspend":false,"commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"facilis","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":2,"pay_term_number":16,"pay_term_type":"months","is_recurring":0,"recur_interval":11,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"voluptatum","recur_repetitions":14,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"inventore","service_custom_field_2":"commodi","service_custom_field_3":"voluptas","service_custom_field_4":"aperiam","service_custom_field_5":"ipsum","service_custom_field_6":"eos","round_off_amount":4,"table_id":11,"service_staff_id":12,"change_return":0,"change_return_id":10,"products":[{"sell_line_id":2,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":4,"discount_amount":0,"discount_type":"percentage","sub_unit_id":3,"note":"fuga"}],"payments":[{"payment_id":9,"amount":453.13,"method":"cash","account_id":12,"card_number":"voluptatum","card_holder_name":"neque","card_transaction_number":"sunt","card_type":"pariatur","card_month":"et","card_year":"veniam","card_security":"non","transaction_no_1":"at","transaction_no_2":"corrupti","transaction_no_3":"saepe","note":"exercitationem","cheque_number":"magnam","bank_account_number":"qui"}]}'
...
let body = {
    ...
    "sale_note": "vel",
    "source": "optio",
    "staff_note": "voluptatum",
    "is_suspend": false,
    "commission_agent": 14,
    "shipping_details": "Express Delivery",
    "shipping_address": "facilis",
    "shipping_status": "ordered",
    "delivered_to": "Mr Robin",
    "shipping_charges": 10,
    "packing_charge": 10,
    ...
    "subscription_no": "voluptatum",
    "recur_repetitions": 14,
    "rp_redeemed": 17,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 2,
    "service_custom_field_1": "inventore",
    "service_custom_field_2": "commodi",
    "service_custom_field_3": "voluptas",
    "service_custom_field_4": "aperiam",
    "service_custom_field_5": "ipsum",
    "service_custom_field_6": "eos",
    "round_off_amount": 4,
    "table_id": 11,
    "service_staff_id": 12,
    "change_return": 0,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 12,
            "card_number": "voluptatum",
            "card_holder_name": "neque",
            "card_transaction_number": "sunt",
            "card_type": "pariatur",
            "card_month": "et",
            "card_year": "veniam",
            "card_security": "non",
            "transaction_no_1": "at",
            "transaction_no_2": "corrupti",
            "transaction_no_3": "saepe",
            "note": "exercitationem",
...
```bash
curl -X DELETE \
    "https://pos.e-buy.lk/public/connector/api/sell/ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":13,"transaction_date":"2020-5-7 15:20:22","invoice_no":"consequuntur","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":13,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":13,"shipping_status":"ordered","delivered_to":"soluta"}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/taxonomy?type=non" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"dignissimos","first_name":"et","last_name":"sunt","email":"magni","is_active":"soluta","user_type":"eos","crm_contact_id":2,"allow_login":true,"username":"voluptatem","password":"corporis","role":11,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"eius","max_sales_discount_percent":"vero","selected_contacts":false,"selected_contact_ids":[],"dob":"quas","gender":"est","marital_status":"ut","blood_group":"fuga","contact_number":"nisi","alt_number":"laudantium","family_number":"deserunt","fb_link":"qui","twitter_link":"asperiores","social_media_1":"id","social_media_2":"nostrum","custom_field_1":"qui","custom_field_2":"aliquid","custom_field_3":"rerum","custom_field_4":"ut","guardian_name":"provident","id_proof_name":"rem","id_proof_number":"quasi","permanent_address":"quia","current_address":"quos","bank_details":[{"account_holder_name":"doloribus","account_number":"expedita","bank_name":"et","bank_code":"doloremque","branch":"est","tax_payer_id":"repellat"}]}'
...
let body = {
    ...
    "cmmsn_percent": "eius",
    "max_sales_discount_percent": "vero",
    ...
    "blood_group": "fuga",
    "contact_number": "nisi",
    "alt_number": "laudantium",
    "family_number": "deserunt",
    "fb_link": "qui",
    "twitter_link": "asperiores",
    "social_media_1": "id",
    "social_media_2": "nostrum",
    "custom_field_1": "qui",
    "custom_field_2": "aliquid",
    "custom_field_3": "rerum",
    "custom_field_4": "ut",
    "guardian_name": "provident",
    "id_proof_name": "rem",
    "id_proof_number": "quasi",
    "permanent_address": "quia",
    "current_address": "quos",
    "bank_details": [
        {
            "account_holder_name": "doloribus",
            "account_number": "expedita",
            "bank_name": "et",
            "bank_code": "doloremque",
            "branch": "est",
            "tax_payer_id": "repellat"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/user?service_staff=consequatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"voluptatem","new_password":"repellendus"}'
...
```bash
curl -X POST \
    "https://pos.e-buy.lk/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"tempora"}'
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "https://pos.e-buy.lk/public/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "https://pos.e-buy.lk/public/connector/api/get-location"
);
